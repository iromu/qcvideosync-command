...
{
    [self performSelectorOnMainThread:@selector(mainThread_updatePeer:) withObject:[NSArray arrayWithObjects:peer,
                                                                                    [NSNumber numberWithDouble:lag], nil] waitUntilDone:NO];
}
