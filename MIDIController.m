...
{
    return b >= 0x80 && b < 0xF8;
}


BOOL isRealtimeByte (Byte b)
{
    return b >= 0xF8;
}
...
unsigned int midiPacketListSize (const MIDIPacketList * packetList)
{
...
unsigned int findEndOfMessage (const MIDIPacket * packet, unsigned int startIndex)
{
